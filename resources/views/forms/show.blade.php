...
<div class="space-y-6 max-w-4xl">
    <!-- Action Header -->
        <div class="flex justify-between items-center">
            <a href="{{ url()->previous() }}"
            class="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-slate-300 text-sm hover:bg-slate-50">
                ← Kembali
            </a>
        ...
        <button
            type="button"
            onclick="window.location.href='{{ route('form.pdf', ['submission' => $submission->submission_code]) }}'"
