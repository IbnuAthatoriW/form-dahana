...
<body class="flex min-h-screen">
    ...
    <aside class="w-64 bg-slate-900 text-slate-300 flex flex-col shrink-0">
        ...
        <div class="h-16 flex items-center px-6 border-b border-slate-800">
            <span class="text-xl font-bold text-white tracking-tight title-font flex items-center">
                DAHANA <span class="text-orange-500 text-2xl font-black leading-none ml-1">.</span>
            </span>
    ...
    <div class="flex-grow flex flex-col min-w-0">
        ...
        <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 shrink-0 shadow-sm z-10">
            <h1 class="text-lg font-bold text-slate-800 title-font">@yield('page_title', 'Admin Dashboard')</h1>
